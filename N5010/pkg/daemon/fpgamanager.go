...
var (
	...
	fpgaUserImageSubfolderPath  = "/N5010-workdir"
...
func (fpga *FPGAManager) UpdateFW(file string, PCIAddr string, idx int, dryRun bool) error {
	...
	log.V(4).Info("Program FPGA completed, start new power cycle N5010 ...")
...
func (fpga *FPGAManager) verifyPCIAddrs(fpgaCR []fpgav1.N5010Fpga) error {
...
func (fpga *FPGAManager) verifyPreconditions(n *fpgav1.N5010Node) error {
...
func (fpga *FPGAManager) ProgramFPGAs(n *fpgav1.N5010Node) error {
