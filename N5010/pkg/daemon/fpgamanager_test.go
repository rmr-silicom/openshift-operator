...
var _ = Describe("FPGA Manager", func() {
	...
	sampleOneFPGA := fpgav1.N5010Node{
		Spec: fpgav1.N5010NodeSpec{
			FPGA: []fpgav1.N5010Fpga{
				{
	...
	sampleTwoFPGAs := fpgav1.N5010Node{
		Spec: fpgav1.N5010NodeSpec{
			FPGA: []fpgav1.N5010Fpga{
				{
					PCIAddr: "0000:1b:00.0",
	...
	sampleWrongUrlFPGA := fpgav1.N5010Node{
		Spec: fpgav1.N5010NodeSpec{
			FPGA: []fpgav1.N5010Fpga{
				{
					PCIAddr:      "0000:1b:00.0",
	...
	var _ = Describe("getFPGAInfo", func() {
		var _ = It("will return valid []N5010FpgaStatus ", func() {
