...
import (
	...
	"github.com/rmr-silicom/openshift-operator/N5010/pkg/daemon"
...
func main() {
	...
	if namespace == "" {
		setupLog.Error(nil, "INTEL_FPGA_NAMESPACE environment variable is empty")
		os.Exit(1)
	}
	...
	daemon := daemon.NewN5010NodeReconciler(mgr.GetClient(), cset, ctrl.Log.WithName("daemon"), nodeName, namespace)
